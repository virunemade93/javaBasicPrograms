...
System.out.println("PNB Rate of Interest is:"+p1.getRateOfInterestForHomeLoan() +"%");
 ...
 System.out.println("RBI referance but object of SBI,Rate of Interest is:"+b1.getRateOfInterestForHomeLoan()+"%");
         RBIBank b2=new PNB();
         
System.out.println("RBI referance but object of PNB,Rate of Interest is:"+b2.getRateOfInterestForHomeLoan()+"%");
